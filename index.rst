...
The data obtained using the system can be used for:
...
If propeller blades or fins are damaged, you can replace them yourself by spare parts and tools from the kit.
...
Geoscan Lite system (without battery) and launcher are recommended to be stored in transport bags in dry room at a temperature of +5 to +25 °C and relative humidity not more than 80% without condensation.
Service life — 2 years.


Batteries should be stored in a cool and dry place without direct sunlight, at a temperature of 5 to 25 °C and a relative humidity of 80% without condensation. The optimum temperature of +5 to +10 °C. 
The optimum voltage level when placing the battery to storage: 15.12 V.
Service life — 1 year.
